...
def built_FSAC_parser():
    ...
    parser.add_argument('--motivation', type=str, default='change 64')  # training testing
    ...
    parser.add_argument('--penalty_start', type=int, default=400000)
    ...
    parser.add_argument('--value_lr_schedule', type=list, default=[5e-5, 2000000, 1e-6])
    parser.add_argument('--cost_value_lr_schedule', type=list, default=[5e-5, 2000000, 1e-6])
    ...
    parser.add_argument('--lam_lr_schedule', type=list, default=[3e-6, 500000, 1e-6])
    parser.add_argument('--alpha', default='auto')  # 'auto' 0.02
    alpha = parser.parse_args().alpha
    if alpha == 'auto':
        parser.add_argument('--target_entropy', type=float, default=-8)
    ...
    parser.add_argument('--save_interval', type=int, default=300000) # 200000
    ...
    results_dir = './results/FSAC/{task}/conti100{experiment}-{time}-s{seed}'.format(task=task,
                                                                      experiment=task,
                                                                      time=time_now,
