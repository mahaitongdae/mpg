...
def built_FSAC_parser():
    ...
    parser.add_argument('--motivation', type=str, default='modify lr, todo:change 64')  # training testing
    ...
    parser.add_argument('--lam_lr_schedule', type=list, default=[1e-6, 500000, 1e-7])
